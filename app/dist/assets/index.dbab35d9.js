...
}`;const vt={mixins:[b],async created(){await this.sanityFetchGenreBooks(kt,{slug:this.$route.params.genre_slug})},props:{genre_slug:{type:String}},components:{BookPreview:N,BackToFrontpage:B},computed:{currentGenre(){return this.$store.getters.getCurrentGenre},genreBooks(){return this.$store.getters.getGenreBooks},noBooksWarning(){return this.genreBooks===0}}},ft={key:0},yt={key:1,class:"genreBooks"},$t={class:"genreBooks__title"},bt={class:"genreBooks__books"},Bt={key:1,class:"genreBooks__books-warning"};function Ct(e,t,r,u,n,s){const i=p("BackToFrontpage"),l=p("BookPreview");return e.loading?(a(),c("div",ft,"LOADING BOOKS")):(a(),c("div",yt,[h(i,{class:"genreBooks__backToFrontpage"}),o("h1",$t,_(s.currentGenre),1),o("section",bt,[s.genreBooks.length!==0?(a(!0),c(m,{key:0},f(s.genreBooks,d=>(a(),v(l,{book:d},null,8,["book"]))),256)):(a(),c("span",Bt,"No books with til genre..."))])]))}var wt=g(vt,[["render",Ct]]),St="/icons/decrease.svg",Tt="/icons/increase.svg",Ft="/icons/remove.svg";const Gt={mixins:[b],created(){console.log("HER",this.$store.getters.getCartLength)},computed:{cart(){return this.$store.getters.getCart},totalSum(){return this.$store.getters.getTotalSum}},methods:{removeFromCart(e){this.$store.dispatch("removeFromCart",e)},increaseQuantity(e){this.$store.dispatch("increaseQuantity",e)},decreaseQuantity(e,t){this.$store.dispatch("decreaseQuantity",e,t)},updateTotalSoldSanity(){this.cart.forEach(e=>{this.updateTotalSold(e._id,e)}),this.$store.dispatch("emptyCartInLocalStorage"),console.log("empty cart?",this.cart)}},components:{BackToFrontpage:B}},Nt={class:"cart"},Pt=o("h2",{class:"cart__title"},"SHOPPINGCART",-1),Lt={key:0,class:"cart__emptyAlert"},Ot={class:"cart__products"},xt={class:"cart__product"},It=["src"],Mt={class:"cart__product-information"},Et={class:"cart__product-title"},Rt={class:"quantity"},qt=["onClick"],At=o("img",{src:St,alt:"increase button"},null,-1),Ht=[At],Qt=["onClick"],Ut=o("img",{src:Tt,alt:"increase button"},null,-1),Vt=[Ut],Wt=["onClick"],Kt=o("img",{src:Ft,alt:"trash icon"},null,-1),jt=[Kt],Dt={key:2,class:"cart__checkout"},Jt={class:"cart__checkout-sum"};function zt(e,t,r,u,n,s){const i=p("BackToFrontpage");return a(),c("div",Nt,[h(i,{class:"cart__backToFrontpage"}),Pt,s.cart.length===0?(a(),c("div",Lt,"Your cart is empty!")):(a(!0),c(m,{key:1},f(s.cart,(l,d)=>(a(),c("section",Ot,[o("div",xt,[o("img",{src:l.cover.asset.url,class:"cart__product-bookCover"},null,8,It),o("div",Mt,[o("span",null,_(l.price)+",-",1),o("h3",Et,_(l.title),1),o("div",Rt,[o("button",{onClick:C=>s.decreaseQuantity(d,l)},Ht,8,qt),o("span",null,_(l.quantity),1),o("button",{onClick:C=>s.increaseQuantity(d)},Vt,8,Qt)])]),o("button",{class:"cart__product-remove",onClick:C=>s.removeFromCart(l)},jt,8,Wt)])]))),256)),s.totalSum!==0?(a(),c("section",Dt,[o("span",Jt,"Total sum: "+_(s.totalSum)+" kr",1),o("button",{class:"cart__checkout-button",onClick:t[0]||(t[0]=(...l)=>s.updateTotalSoldSanity&&s.updateTotalSoldSanity(...l))},"GO TO CHECKOUT")])):y("",!0)])}var Yt=g(Gt,[["render",zt]]),Xt=[{name:"frontpage",path:"/",component:Je},{name:"book",path:"/books/:book_slug",component:mt},{name:"genre",path:"/:genre_slug",component:wt},{name:"cart",path:"/cart",component:Yt}];const Zt=R(Fe),eo=q({routes:Xt,history:A(),scrollBehavior(e,t,r){return{left:0,top:0}}});H(Be).use(Zt).use(eo).mount("#app");
